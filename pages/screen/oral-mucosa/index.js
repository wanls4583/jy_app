...
Page({
    ...
    gotoResult(data, redirect) {
        ...
        const url = `/pages/screen/evaluate-result/index?title=口腔黏膜风险评估&result=${result}&_result=${this.data.result}&share=${this.share}&filtrateId=${data.filtrateId}&filtrateType=${data.type}`
